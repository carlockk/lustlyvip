...
const STRINGS = {
  es: {
    ...
    choosePlanHelper: 'Selecciona un plan y revisa los detalles antes de continuar con el pago.',
    ...
    searching: 'Buscando...',
    searchPostsOrCreatorsLabel: 'Busca en Lustly',
    searchPostsOrCreatorsPlaceholder: 'Buscar publicaciones o creadores',
    searchError: 'No se pudo completar la búsqueda.',
    noSearchResults: 'Sin coincidencias por ahora.',
    searchCreatorsHeading: 'Creadores',
    searchPostsHeading: 'Publicaciones',
    postMediaAlt: 'Contenido de la publicación',
    viewFull: 'Ver completo',
    close: 'Cerrar',
    clear: 'Limpiar',
    noPlansFound: 'No encontramos planes disponibles por ahora.',
    autoRenewLabel: 'Renovar automáticamente al terminar el periodo.',
    customEndDate: 'Elegir fecha de finalización',
    customEndDateSelected: 'Finaliza el',
    continueToCheckout: 'Continuar al pago',
    openingCheckout: 'Abriendo checkout...',
    selectPlanFirst: 'Selecciona un plan para continuar.',
    customEndDateRequiresDailyPlan: 'Para elegir una fecha personalizada necesitas un plan diario activo.',
    checkoutPopupHint: 'Abrimos una ventana con el checkout seguro de Stripe. Si no la ves, habilita las ventanas emergentes y vuelve a intentarlo.',
    openCheckoutCta: 'Abrir checkout',
    popupBlockedWarning: 'Tu navegador bloqueó la ventana emergente. Habilita los pop-ups o abre el enlace manualmente.',
    ppvCheckoutTitle: 'Completa tu compra PPV',
    subscriptionCheckoutTitle: 'Completa tu suscripción',
    processingPayment: 'Procesando...',
    plansLoadError: 'No se pudieron cargar los planes.',
    subscriptionPlansUnavailable: 'Este creador tiene monetización activa, pero los planes no están disponibles por el momento.',
    subscriptionCreateError: 'No se pudo suscribir.',
    messagingOnlyPaid: 'Los mensajes se activan con una suscripción pagada.',
  ...
  en: {
    ...
    choosePlanHelper: 'Pick a plan and review the details before continuing.',
    ...
    searching: 'Searching...',
    searchPostsOrCreatorsLabel: 'Search Lustly',
    searchPostsOrCreatorsPlaceholder: 'Search posts or creators',
    searchError: 'Search could not be completed.',
    noSearchResults: 'No matches yet.',
    searchCreatorsHeading: 'Creators',
    searchPostsHeading: 'Posts',
    postMediaAlt: 'Post media',
    viewFull: 'View full',
    close: 'Close',
    clear: 'Clear',
    noPlansFound: 'We could not find available plans right now.',
    autoRenewLabel: 'Renew automatically at the end of the period.',
    customEndDate: 'Choose end date',
    customEndDateSelected: 'Ends on',
    continueToCheckout: 'Continue to checkout',
    openingCheckout: 'Opening checkout...',
    selectPlanFirst: 'Select a plan to continue.',
    customEndDateRequiresDailyPlan: 'A daily plan is required to use a custom end date.',
    checkoutPopupHint: 'We opened a secure Stripe checkout window. If you cannot see it, allow pop-ups and try again.',
    openCheckoutCta: 'Open checkout',
    popupBlockedWarning: 'Your browser blocked the pop-up. Allow pop-ups or open the link manually.',
    ppvCheckoutTitle: 'Complete your PPV purchase',
    subscriptionCheckoutTitle: 'Complete your subscription',
    processingPayment: 'Processing...',
    plansLoadError: 'We could not load the plans.',
    subscriptionPlansUnavailable: 'This creator has monetization enabled but plans are unavailable right now.',
    subscriptionCreateError: 'We could not subscribe you.',
    messagingOnlyPaid: 'Messaging is enabled only with a paid subscription.',
